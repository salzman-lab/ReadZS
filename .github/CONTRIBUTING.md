# nf-core/readzs: Contributing Guidelines

Hi there!
Many thanks for taking an interest in improving nf-core/readzs.

We try to manage the required tasks for nf-core/readzs using GitHub issues, you probably came to this page when creating one.
...
To make the nf-core/readzs code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
